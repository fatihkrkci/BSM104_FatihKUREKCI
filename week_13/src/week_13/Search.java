...
public class Search {
	...
	public static void main(String[] args) {
		...
		//int index = indexOf(numbers, 29);		//Sıralı Olmayan Dizi
		//int index = indexOf2(numbers2, 30);	//Sıralı Olan Dizi
		int index=binarySearchR(numbers2, 51, 0, numbers2.length-1);	//Binary Search
		
		if(index!=-1) {
			System.out.println("Elemanin İndeksi: " + index);
		} else {
